  ...
  return (
    <div className='mx-3 md:mx-20'>
        <div className='flex gap-2 overflow-x-scroll scrollbar-hide pb-1 bg-[#000000] border-gray-700 border-r-[1px] border-l-[1px] px-2 '>
            ...
            <p className='flex bg-emerald-800 hover:cursor-pointer flex-shrink-0 font-bold items-center justify-center rounded-full w-8 h-8 hover:border-[1px]' key={profile.id} title={profile.username}>
